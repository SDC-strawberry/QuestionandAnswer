...
export let options = {
  stages: [
    { duration: '10s', target: 200 }, // simulate ramp-up of traffic from 1 to 100 users over 5 minutes.
    { duration: '1m', target: 200 }, // stay at 150 users for 1 minutes
...
export default function () {
  ...
  //GET QUESTIONS ROUTE
  for (var id = 61; id <= 120; id++) {
    http.get(`http://ec2-3-133-87-163.us-east-2.compute.amazonaws.com:3000/qa/questions/?product_id=${id}`);
    sleep(1);
  }
